...
while True:
    ...
    connection_string = postgresql.connection_string.replace(postgresql.host, os.getenv("DEIS_DATABASE_SERVICE_HOST")).replace(postgresql.port, os.getenv("DEIS_DATABASE_SERVICE_PORT"))
